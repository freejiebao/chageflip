...
parser.add_argument('-p','--plot', help='make mll distribution, default is true',action='store_true', default= False)
...
def fit(filename):
    ...
    for ihis in histos:
        ...
        w.factory("BreitWigner:sig_bw(mll[76.1876, 106.1876], bwmean[91.1876,89,93],bwgamma[2.4952,2.4,2.6])")
        ...
        w.factory("Exponential:bkg(mll,exalpha[-1.,-10,-0.1])")
    ...
    if args.plot:
        ...
        for sample_name in sample_names:
            ...
            if sample_name=="DATA":
                ...
                if args.year == '2017':
                    weight="METFilter_FAKE*fakeW2l_ele_mvaFall17V2Iso_WP90_SS_mu_cut_Tight_HWWW"
                elif args.year == '2016':
